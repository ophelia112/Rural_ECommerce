...
<div class="type_style">
 <div class="type_title">修改商品折后价</div>
  <div class="type_content">
  <form action="UpdateDiscountPriceServlet" method="post" class="form form-horizontal" id="form-article-add">
    <div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>商品ID</label>
		 <div class="formControls col-10"><input type="text" class="input-text" name="id"></div>
		</div>
		<div class=" clearfix cl">	
		<label class="form-label col-2"><span class="c-red">*</span>商品折后价：</label>
