...
<body style="background:url(assets/resultBG/board2.jpg); background-size:100% 100%; background-attachment:fixed">  
    <div class="wrap">  
        <table>  
            <tr>  
                <td rowspan="5" style=""><img src="assets/resultBG/hzw.jpg" width="200" height="200" alt="一个极简的登陆成功页面"></td>  
                <td class="header">恭喜你！保存成功</td>  
            </tr>  
           
            <tr><td>你可以前往<a href="myaccount.jsp">我的账户</a></td></tr>  
            <tr><td class="check-info">你也可以<a href="index.jsp">预先浏览一下我们的网站</a></td></tr>  
        </table>  
    </div>  
</body>  
</html>