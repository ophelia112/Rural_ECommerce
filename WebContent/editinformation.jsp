                        ...
                        <div class="cart-hover">
                            ...
                            <ul class="pop-up-box cart-popup">
                                ...
                                <li class="cart-list buttons">
                                    <div class="pull-left"><a href="shoppingcart.html" class="theme-btn-sm-2">查看购物车</a></div>
                                </li>
                            </ul>
                        </div>
                        <!--商品展开-->
                ...
                <div class="theme-container container ">                       
                    <div class="site-breadcumb white-clr">                        
                        ...
                        <ol class="breadcrumb breadcrumb-menubar">
                            <li><a href="index.jsp">首页</a>账户信息</li>                             
                        </ol>
                    </div>  
                </div>
            </section>
            <section>
                <form action="UpdateServlet" method="post" width="600"  height="400" border="0" cellspacing="50" cellpadding="0" align="0">
                    <table width="700"  height="400" border="0" cellspacing="50" cellpadding="0" align="center">
                        <tr>
                            <td><strong>电话号码</strong></td>
                            <td><input class="form-control" placeholder="输入你的电话号码"  name="tel"  required="" input type="tel"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" placeholder="输入你的姓名"  name="name"  required="" input type="name"></td>
                        </tr>
                        <tr>
                            <td><strong>邮 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 箱</strong></td>
                            <td><input class="form-control" placeholder="输入你的邮箱"  name="mailbox"  required="" input type="mailbox"></td>
                        </tr>
                        <tr>
                            <td><strong>地 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 址</strong></td>
                            <td><input class="form-control" placeholder="输入你的地址"  name="address"  required="" input type="address"></td>
                        </tr>
                        <tr>
                            <td ></td>
                            <td>
