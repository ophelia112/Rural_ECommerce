                                        ...
                                        <div class="account-body">
                                            <ul class="acnt-list">
                                                <li>  
                                                    ...
                                                    <a href="editinformation.jsp"> 编辑您的帐户信息</a>
                                                </li>
                                                <li> 
                                                     <i class="fa fa-arrow-circle-o-right clr-txt"></i>  
                                                    <a href="editinformation.jsp"> 更换你的密码</a>
                                                </li>
                                                <li>          
                                                     <i class="fa fa-arrow-circle-o-right clr-txt"></i> 
                                                    <a href="editinformation.jsp"> 修改收货地址</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="panel"> 
                                    <div class="accordion-heading">                              
                                        <a class="title-2" data-toggle="collapse" data-parent="#accordion" href="#accordion-2"> 
                                            <span class="light-font">02. 购物 </span> 
                                            <strong>  查询 </strong>  
                                        </a>                              
                                    </div>
                                    <div id="accordion-2" class="panel-collapse collapse">
                                        <div class="account-body">
                                            <ul class="acnt-list">
                                                <li> 
                                                    <i class="fa fa-arrow-circle-o-right clr-txt"></i> 
                                                    <a href="QueryOrder.jsp"> 订单查询</a>
                                                </li>
                                                <li>
                                                     <i class="fa fa-arrow-circle-o-right clr-txt"></i>  
                                                    <a href="shoppingcart.jsp"> 购物车查询</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
