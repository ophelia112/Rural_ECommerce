...
<head>  
    ...
    <style>  
        ...
        td{text-align:center; padding:2px 10px;}  
...
<body style="background:url(images/Gbg2.jpg); background-size:100% 100%; background-attachment:fixed">  
    <div class="wrap">  
        <table>  
            <tr>  
                <td ="middle" class="header">添加成功</td>
            </tr>  
           	<tr><td>返回<a href="Ghome.jsp">主页面</a></td></tr>  
           	<tr><td>返回<a href="shoppingcart.jsp">购物车页面</a></td></tr>  
        </table>  
    </div>  
</body>  
</html>  