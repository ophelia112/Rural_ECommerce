                ...
                <div class="theme-container container ">                       
                    <div class="site-breadcumb white-clr">                        
                        ...
                        <ol class="breadcrumb breadcrumb-menubar">
                            <li><a href="index.jsp">首页</a>商店</li> 
                            <li><a href="GShowAlldispro.jsp">显示所有折扣商品</a></li>                            
                        </ol>
                    </div>  
                </div>
            </section>
                ...
                <div class="container"> 
                    ...
                    <div class="tabs-box text-center">
                        <ul class="theme-tabs small">
                            <li class="">
                                <a href="#naturix-tab-1" data-toggle="tab">
                                    <span class="light-font">所有</span> 
                                    <strong>商品</strong> 
                                </a>
                            </li>                                
                            <li class="active">
                                <a href="#naturix-tab-2" data-toggle="tab"> 
                                    <span class="light-font">所有</span> 
                                    <strong>水果</strong> 
                                </a>
                            </li>                               
                            <li class="">
                                <a href="#naturix-tab-3" data-toggle="tab"> 
                                    <span class="light-font">所有</span> 
                                    <strong>蔬菜</strong> 
                                </a>
                            </li>
                            <li class="">
                                <a href="#naturix-tab-4" data-toggle="tab"> 
                                    <span class="light-font">所有</span> 
                                    <strong>果汁</strong> 
                                </a>
                            </li>
                            <li class="">
                                <a href="#naturix-tab-5" data-toggle="tab"> 
                                    <span class="light-font">所有</span> 
                                    <strong>坚果</strong> 
                                </a>
                            </li>
                                ...
                                <div class="item"> 
                                    ...
                                    <div class="product-box"> 
                                        ...
                                        <div class="product-caption"> 
                                            ...
                                            <div class="price">
                                                <del class="light-font">&yen;65.00</del> 
                                                <strong class="clr-txt">&yen;50.00</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
