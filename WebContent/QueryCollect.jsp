...
<style>
    ...
    {
        margin: 80px auto;
        background: url('board2.jpg') no-repeat;
    ...
    <body id="home" class="wide">
        <main class="wrapper">
            ...
            <section class="account-page ptb-50">
                <div class="container"> 
                    <div class="row">  
                         <form action="QueryAllCollectServlet" method="post" method="post" width="600"  height="200" border="0" cellspacing="0" cellpadding="0" align="0">
                    <table width="600"  height="200" border="0" cellspacing="10" cellpadding="20" align="10px" >
                    <tr><td><h4 align="center">请正确输入您的用户名ID，进行查询</h2></td></tr>
                    <tr>
                    	
                        <td>用户ID</td>
                        <td><input class="form-control" placeholder="输入你的用户ID" name="useid" required="" type="text"></td>
                    </tr>
